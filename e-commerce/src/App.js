...
function App() {
  ...
  const produtos = [
    {id: 1,quantidade: 0,img: Img1,nome: "Casaco galáxia universo estrelas rosa",preco: 40.22, precoCompra: 0},
    {id: 2,quantidade: 0,img: Img2,nome: "Moletom Cropped Espaço Planeta",preco: 44.42, precoCompra: 0},
    {id: 3,quantidade: 0,img: Img3,nome: "Moletom Planetas Sistema Solar",preco: 64.22, precoCompra: 0},
    {id: 4,quantidade: 0,img: Img4,nome: "Moletom Espaço Astronauta",preco: 62.22, precoCompra: 0},
    {id: 5,quantidade: 0,img: Img5,nome: "Camisa Nasa Astronauta Marte",preco: 24.82, precoCompra: 0},
    {id: 6,quantidade: 0,img: Img6,nome: "Camisa alienígena",preco: 46.62, precoCompra: 0},
    {id: 7,quantidade: 0,img: Img7,nome: "Camisa Feminina Galáxia",preco: 48.42, precoCompra: 0},
    {id: 8,quantidade: 0,img: Img8,nome: "Camisa galáxia na ponta dos dedos",preco: 46.22, precoCompra: 0},
